  ...
  return (
    ...
    <CardContainer  className="inter-var">
      <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1]  w-auto  h-auto rounded-xl p-6 border  ">
        ...
        >
          I am a Full Stack Developer deep diving into web development also interested in AI technology, Building new stuff always excites me.Looking forward for opportunities, so let's grab a coffee and have a meet 
        </CardItem>
