...
export function AnimatedTooltipPreview() {
  return (
    <div>
        <h1 className="flex flex-row items-center justify-center mb-10 w-full p-4 mt-4 text-white text-4xl">Skills</h1>
    <div id="skills" className="flex flex-row items-center justify-center mb-10 w-full">
